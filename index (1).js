...
const wordOfTheDayChannelIds = {
  ...
  german: 'your_german_channel_id',   // Replace with actual German channel ID
  french: 'your_french_channel_id',   // Replace with actual French channel ID
};
...
const sendWordOfTheDay = async (language) => {
  ...
  const embedColors = {
    russian: '#7907ff',  // Purple color for Russian
    german: '#f4ed09',   // Yellow color for German
    french: '#09ebf6',   // Blue color for French
  };
...
const wordOfTheDayTimes = {
  russian: '34 13 * * *',  // 12:59 PM IST for Russian
  german: '59 14 * * *',   // 2:59 PM IST for German
  french: '59 16 * * *',   // 4:59 PM IST for French
};
...
activeQuizzes[message.author.id].detailedResults.push({
    ...
    correct: question.correct,  // This now correctly refers to the actual word
